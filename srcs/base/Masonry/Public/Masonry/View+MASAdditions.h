 ...
 */
- (NSArray *)mas_makeConstraints:(void(NS_NOESCAPE ^)(MASConstraintMaker *make))block __attribute__((deprecated("use func without block")));
- (MASConstraintMaker *)mas_makeConstraints;
 ...
 */
- (NSArray *)mas_updateConstraints:(void(NS_NOESCAPE ^)(MASConstraintMaker *make))block __attribute__((deprecated("use func without block")));
- (MASConstraintMaker *)mas_updateConstraints;
 ...
 *  @return Array of created/updated MASConstraints
 */
- (NSArray *)mas_remakeConstraints:(void(NS_NOESCAPE ^)(MASConstraintMaker *make))block __attribute__((deprecated("use func without block")));
- (MASConstraintMaker *)mas_remakeConstraints;
